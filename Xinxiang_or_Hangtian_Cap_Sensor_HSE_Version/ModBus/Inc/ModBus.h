...
#define HOLDING_REG_REGION1_END         0x0060                                ///< 保持寄存器结束地址1

#define INPUT_REG_REGION1_BEGIN         0x0000                                ///< 输入寄存器起始地址1
#define INPUT_REG_REGION1_END           0x0012                                ///< 输入寄存器结束地址1
#define INPUT_REG_REGION2_BEGIN         0x0080                                ///< 输入寄存器起始地址2
#define INPUT_REG_REGION2_END           0x008C                                ///< 输入寄存器结束地址2
...
#define MUL_REG_REGION1_END             0x0060                                ///< 多个寄存器结束地址1

#define _25_FNUC_REG_REGION1_BEGIN      0x0000                                ///< 自定义25功能码寄存器起始地址
#define _25_FNUC_REG_REGION1_END        0x000E                                ///< 自定义25功能码寄存器结束地址

#define DEF_MUL_REG_REGION1_BEGIN       0x0080                                ///< 自定义26/27功能码寄存器起始地址1
#define DEF_MUL_REG_REGION1_END         0x00D8                                ///< 自定义26/27功能码寄存器结束地址1
...
#endif // BOOT_PROGRAM
    /** ModBus回调函数 */
    int     (*ModBus_CallBack) (struct _ModBusBaseParam_TypeDef *ModBusBaseParam, void *arg);
